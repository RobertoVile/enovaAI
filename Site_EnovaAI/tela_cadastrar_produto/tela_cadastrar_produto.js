document.addEventListener('DOMContentLoaded', () => {
            ...
            function showModal(message, isSuccess = false) {
                ...
                // Adiciona um listener para fechar o pop-up
                modalOkBtn.onclick = () => {
                    modal.style.display = 'none';
                    if (isSuccess) {
                        form.reset(); // Limpa o formulário se o cadastro for um sucesso
                        fileInputDisplays.forEach(display => display.value = '');
                    }
                };
            }

            // --- Validações de acordo com o documento ---
            function validateForm() {
                // RF01: Validações de campos obrigatórios e formato
                ...
                if (isNaN(precoValue) || precoValue < 0) {
                    showModal("Erro: Preço Unitário deve ser um número decimal positivo.");
                    return false;
                }
                ...
                // RF01: Validação de formato de imagem 3D (opcional)
            ...
            // --- Event Listeners para funcionalidade dos botões e campos de arquivo ---
